        ...
        @foreach($dsCongViecs as $congViec)
            ...
            <tr style="cursor: pointer;" data="{{$congViec->id}}" class="js-xem-cay-xu-ly <?php if($stt==1){echo 'active';} ?>">
                ...
                <td class="text-center">
                    <button type="button" data="{{$congViec->id}}"  data-toggle="modal" data-target=".bs-giao-viec-modal-lg" class="btn btn-gradient waves-effect waves-light js-giao-viec" data-toggle="tooltip" title="Cập nhật phân công"><i class="dripicons-document-edit"></i></button>
    ...
    <div class="modal-dialog modal-lg center-giao-viec">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-giao-viec"><i class="dripicons-alarm"></i> Cập nhật</button>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        function loadDsCongViecDaGiaoV2(_token){                
            var xhr1;   
            var url="{{ route('loadDsCongViecDaGiaoV2') }}";
        ...
        */
        ...
        jQuery('.btn-giao-viec').on('click',function(){
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('capNhatGiaoViecXuLyV2') }}",
                data: formData,
                contentType: false,
                processData: false,
                error:function(){
