...
?>
<form id="frm_xu_ly_cong_viec" name="frm_xu_ly_cong_viec"  enctype="multipart/form-data">
                {{ csrf_field() }}
</form>                
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            <div class="row">
                <div class="col-lg-6"><h5>XỬ LÝ CÔNG VIỆC</h5></div>
...
<div class="row add-form">    
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            var _token=jQuery('form[name="frm_xu_ly_cong_viec"]').find("input[name='_token']").val();
