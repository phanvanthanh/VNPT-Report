...
?>
<form id="frm_lanh_dao_ho_tro" name="frm_lanh_dao_ho_tro"  enctype="multipart/form-data">
    {{ csrf_field() }}
</form>                
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            <div class="row">
                <div class="col-lg-6"><h5>LÃNH ĐẠO HỖ TRỢ XỬ LÝ</h5></div>
...
<div class="row add-form">    
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            var _token=jQuery('form[name="frm_lanh_dao_ho_tro"]').find("input[name='_token']").val();
