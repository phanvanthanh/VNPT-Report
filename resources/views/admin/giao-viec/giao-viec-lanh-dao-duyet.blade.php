...
?>
<form id="frm_lanh_dao_duyet" name="frm_lanh_dao_duyet"  enctype="multipart/form-data">
    {{ csrf_field() }}
</form>                
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            <div class="row">
                <div class="col-lg-6"><h5>LÃNH ĐẠO DUYỆT</h5></div>
...
<div class="row add-form">    
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            var _token=jQuery('form[name="frm_lanh_dao_duyet"]').find("input[name='_token']").val();
